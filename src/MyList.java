...
public class MyList<T> {
    ...
    если совпадает запоминаем массив и расширяем тукущий на 1 элемент копируем обратно, добавляем элемент
    */
    public void push(T elem) {
        if (curLen == mass.length) {
            T[] tempMass = mass;
            mass = (T[]) new Object[curLen+1];
            //скажешь что написал циклом предложила IDE исправить
    ...
    совпадает ли длина пассива с текущей длиной доступного списка
    если совпадает запоминаем массив и расширяем тукущий на 1 элемент копируем обратно,
